...
Ainoana ehdotuksena Copilot ehdotti, että score_name(self, score): metodin loppuun lisätään raise ValueError, jos metodia yritetään käyttää 3 suuremmalla luvulla.
